      ...
      <main id="top" className="dashboard">
        ...
        <section className="explain-grid">
          <article className="panel"><header className="panel-header"><div><h2>Forecast lifecycle</h2><p>What enters the equation and how it becomes a score.</p></div></header><ol className="pipeline">
            <li><b>1</b><div><strong>Observe</strong><span>Completed Bybit spot candles and order book, plus available Bybit perpetual-futures measurements, are captured at an exact UTC boundary.</span></div></li><li><b>2</b><div><strong>Calculate</strong><span>Returns, RSI, MACD, ATR, volume and moving-average distances are produced in ordinary code.</span></div></li><li><b>3</b><div><strong>Ask Jev</strong><span>The neutral structured State and an atomic higher-or-lower question produce a full probability distribution.</span></div></li><li><b>4</b><div><strong>Freeze</strong><span>The original price, target timestamp and probabilities are saved before the outcome exists.</span></div></li><li><b>5</b><div><strong>Settle</strong><span>At the target, code retrieves the exact completed Bybit Spot 1-minute close and calculates accuracy, Brier score and log loss.</span></div></li>
          </ol></article>
